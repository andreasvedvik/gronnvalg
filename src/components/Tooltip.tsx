    ...
    >
      ...
      {isVisible && (
        <div
          ...
          role="tooltip"
        >
          <div className="relative bg-gray-800 dark:bg-gray-200 text-white dark:text-gray-800 text-xs font-medium px-2.5 py-1.5 rounded-lg shadow-lg whitespace-nowrap animate-fadeIn">
            {content}
